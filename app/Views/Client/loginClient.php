...
<main class="auth-shell">
    <section class="auth-story" aria-label="Presentation du service">
        ...
        <div class="story-copy">
            ...
            <div class="trust-row">
                <span><svg viewBox="0 0 24 24"><path d="M12 3 5 6v5c0 4.5 2.9 8.6 7 10 4.1-1.4 7-5.5 7-10V6l-7-3Z"/><path d="m9 12 2 2 4-4"/></svg> Sécurisé</span>
                <span><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/></svg> Disponible 24/7</span>
            </div>
        </div>
    ...
    <section class="auth-panel">
        <div class="login-box">
            ...
            <div class="login-icon" aria-hidden="true">
                <svg viewBox="0 0 24 24"><rect x="5" y="2.5" width="14" height="19" rx="3"/><path d="M9 6h6M10 18h4"/></svg>
            </div>
            ...
            <form action="<?= site_url('connexion/client') ?>" method="post" class="login-form">
                ...
                <div class="phone-field">
                    ...
                    <input id="telephone" name="telephone" type="tel" value="<?= esc(old('telephone')) ?>" placeholder="33 12 345 67" inputmode="numeric" autocomplete="tel" maxlength="13" required autofocus>
                </div>
            ...
            <div class="secure-note"><svg viewBox="0 0 24 24"><rect x="5" y="10" width="14" height="10" rx="2"/><path d="M8 10V7a4 4 0 0 1 8 0v3"/></svg> Connexion protégée et données chiffrées</div>
            <div class="operator-link">Vous travaillez chez Vola ? <a href="<?= site_url('connexion/operateur') ?>">Accès opérateur <span>↗</span></a></div>
        </div>
        <p class="legal">En continuant, vous acceptez nos <a href="#">conditions d’utilisation</a> et notre <a href="#">politique de confidentialité</a>.</p>
    </section>
